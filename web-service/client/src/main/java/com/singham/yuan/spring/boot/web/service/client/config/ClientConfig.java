...
public class ClientConfig {
    ...
    public WebServiceTemplate getWebServiceTemplate() {
        ...
        webServiceTemplate.setMarshaller(getClientBodyMarshaller());
        webServiceTemplate.setUnmarshaller(getClientBodyMarshaller());
    ...
    @Bean(name = "headMarshaller")
    public Jaxb2Marshaller getClientHeadMarshaller() {
        Jaxb2Marshaller jaxb2Marshaller = new Jaxb2Marshaller();
        jaxb2Marshaller.setContextPath("com.singham.yuan.head");
    ...
    @Bean(name = "bodyMarshaller")
    public Jaxb2Marshaller getClientBodyMarshaller() {
        Jaxb2Marshaller jaxb2Marshaller = new Jaxb2Marshaller();
        jaxb2Marshaller.setContextPath("com.singham.yuan.body");
        HashMap<String, Object> marshallerProperties = new HashMap<>();
        marshallerProperties.put("com.sun.xml.bind.namespacePrefixMapper", new NamespacePrefixMapperImpl());
        jaxb2Marshaller.setMarshallerProperties(marshallerProperties);
        return jaxb2Marshaller;
